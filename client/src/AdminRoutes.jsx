...
import AdminNomenclature  from './pages/admin/AdminNomenclature';
...
/**
 * Продакт матрица — всё, что живёт под /admin.
 *
 * Вынесено из App.jsx отдельным модулем, чтобы Vite собрал админку в собственный чанк:
 * Telegram-магазин открывают покупатели с телефона, и качать ради витрины трёхмегабайтную
 * админку они не должны. Пути здесь относительные — компонент подключён как /* .
 */
export default function AdminRoutes() {
  useVersionCheck();   // авто-перезагрузка вкладки после нового деплоя
