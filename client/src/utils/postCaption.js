...
//
// ВАЖНО: файл-близнец на сервере — server/lib/postCaption.js.
...
export { buildCaption, ctaLine, priceLine, extractNameParams, withTypePrefix, htmlToPlain, formatPhone, visibleLength, postTitle, setLabel, whatsappLink, esc, ORDER_WHATSAPP };
