...
const BASES = {
  ...
  tubes: {
    ...
    // Цену из ведомости не берём. «Цена» там — средняя себестоимость метра за
    // период, и загрузка остатков молча переписывала ею закупочную цену труб,
    // затирая проставленную руками (11.09.2026 цены обнулили — ближайшая
    // загрузка остатков вернула их обратно). Остатки обновляют остатки.
